...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
                ...
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <b>Key name: </b>
                                <xsl:value-of select="metadata/keyname" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <b>Date: </b>
                                <xsl:value-of select="metadata/bdate" />
                                -
                                <xsl:value-of select="metadata/edate" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <xsl:choose>
                                    <xsl:when test="metadata/supervisor/@homepage">
                                        <a href="{metadata/supervisor/@homepage}">
    ...
    <xsl:template match="abstract/p">
        <p>
            <xsl:apply-templates select="text()|p|b|i|u|xref" />
        </p>
    </xsl:template>
